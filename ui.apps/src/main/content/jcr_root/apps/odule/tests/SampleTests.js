...
new hobs.TestSuite("Custom Login Module Tests", {path:"/apps/odule/tests/SampleTests.js", register: true})
    ...
    .addTestCase(new hobs.TestCase("Hello World component on english page")
        ...
        .asserts.location("/content/customLoginModule/en.html", true)
        .asserts.visible(".helloworld", true)
    )

    .addTestCase(new hobs.TestCase("Hello World component on french page")
        .navigateTo("/content/customLoginModule/fr.html")
        .asserts.location("/content/customLoginModule/fr.html", true)
        .asserts.visible(".helloworld", true)
    );
